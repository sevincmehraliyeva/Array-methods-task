...
// 1. freight 1 den kicik olan sifarisleri console-a yazdir

// const filter = results.filter(item=> item.order.freight<1);
// console.log(filter);

// 2. customerID ERNSH olan neçə ədəd sifariş var?

// const customer =results.filter(item=> item.order.customerID ==="ERNSH").length
...
// const order=results.filter(item=>item.order.length>3);
// console.log(order);

// 5.İD-si 11075 olanı tap və yazdır. (find)

const find=results.find(item => item.order.id===11075)
console.log(find);
